...
--          if tonumber(status) and (status < 208 or status==401 and headers['www-authenticate']) and args.success then 
          if tonumber(status) and (status < 208 or status==401 and headers['www-authenticate'] or status==302 and headers['location']) and args.success then 
...
--    if tonumber(status) and status < 208 and args.success then 
    if tonumber(status) and (status < 208 or status == 302) and args.success then 
